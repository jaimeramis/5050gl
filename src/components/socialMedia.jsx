  ...
  return (
    <>
      ...
      <a
        ...
        target="_blank"
        className={`${color} cursor-pointer rounded-full p-3 transition duration-300 ease-in-out hover:bg-facebook hover:fill-white`}
      >
        <svg
      ...
      <a
        ...
        target="_blank"
        className={`${color} cursor-pointer rounded-full p-3 transition duration-300 ease-in-out hover:bg-instagram hover:fill-white`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <a
        ...
        target="_blank"
        className={`${color} cursor-pointer rounded-full p-3 transition duration-300 ease-in-out hover:bg-linkedin hover:fill-white`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <a
        href={social.tiktok}
        target="_blank"
        className={`${color} cursor-pointer rounded-full p-3 transition duration-300 ease-in-out hover:bg-tiktok hover:fill-white`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <a
        href={social.x}
        target="_blank"
        className={`${color} cursor-pointer rounded-full p-3 transition duration-300 ease-in-out hover:bg-x hover:fill-white`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <a
        href={social.youtube}
        target="_blank"
        className={`${color} cursor-pointer rounded-full p-3 transition duration-300 ease-in-out hover:bg-youtube hover:fill-white`}
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
